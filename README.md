...
- Botón para abrir el correo con los destinatarios configurados:
...
El botón `Abrir correo` descarga primero el informe y después abre la aplicación de correo predeterminada con los cinco destinatarios y un resumen ya preparado. El archivo descargado debe adjuntarse manualmente al correo. Esto permite mantener la aplicación como sitio estático sin servidor ni credenciales de correo.
