...
- Informe descargable, imprimible y compartible en PDF.
- Envío del informe como archivo PDF adjunto cuando se configura el servicio de correo.
...
El correo automático requiere un remitente verificado y la configuración correspondiente del servicio de correo. El PDF se genera en el navegador e incluye las fotografías y las medidas abiertas. Si el correo no está activado o el informe supera el límite de envío, la aplicación descarga el PDF y prepara un correo para adjuntarlo manualmente.
